...
s = Srec()
s.generate_srec(type=2, bin_start=0x200, read_length=0x2000, address_start=0x5000)
s.generate_srec(type=2, bin_start=0x300, read_length=0x3000, address_start=0x5000)
s.generate_srec(type=2, bin_start=0x400, read_length=0x4000, address_start=0x6000)
