...
class CanShow:
    ...
    def add_label(self):
        ...
        self.label_8.place(x=30, y=80, anchor="nw")
        self.label_3.place(x=30, y=110, anchor="nw")
        self.label_4.place(x=30, y=140, anchor="nw")
        self.label_5.place(x=30, y=170, anchor="nw")
        self.label_6.place(x=30, y=200, anchor="nw")
        self.label_7.place(x=30, y=230, anchor="nw")
            ...
            if res is not None:
                ...
                if len(CPO.multiple_id_180) == 0:
                    ...
                    if ch1_id == CPO.multiple_id_180[0]:
                        ...
                        content = "0x%03X %s" % (show_frame_id, CPO.complete_package_180)
                        logger(content)
